...
let _comments = [
  ...
  { id: 5, postId: 3, postTitle: '设备保养小技巧分享，延长设备寿命', topicName: '#保养技巧', userId: 'user-006', userName: '安全员小李', content: '保养工作做得很到位', createdAt: '2026-07-12 09:30:00', likeCount: 4, status: '已删除', deleteReason: '违规内容：包含不当引导信息', deleteTime: '2026-07-12 10:02:18', deleter: '管理员' },
...
export const deleteCommentByAdmin = (id, operator, reason) => {
  ...
  if (!item || item.status === '已删除') return false;

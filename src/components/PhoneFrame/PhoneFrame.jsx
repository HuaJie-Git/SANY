...
const PhoneFrame = ({ topNav, bottomNav, children, hideGradient = false, floatingButton }) => {
  return (
        ...
        <div className="w-[393px] h-[852px] bg-black rounded-[55px] p-[12px] shadow-2xl">
          ...
          <div className="w-full h-full bg-white rounded-[43px] overflow-hidden relative flex flex-col">
            ...
            <div className="flex-shrink-0" style={hideGradient ? {} : { background: 'linear-gradient(180deg, #000000 0%, #BC000F 100%)' }}>
              {/* 状态栏 */}
              <div className="w-full h-7 flex items-center justify-between px-6 text-white">
                {/* 时间 */}
                ...
                <div className="flex items-center gap-1">
                  {/* 信号强度 */}
                  <svg width="15" height="10" viewBox="0 0 15 10" fill="white" style={{ filter: 'brightness(1.3)' }} className="flex-shrink-0">
                  ...
                  {/* WiFi */}
                  <svg width="20" height="14" viewBox="0 0 12 9" fill="none" stroke="white" strokeWidth="1.5" style={{ filter: 'brightness(1.3)' }} className="flex-shrink-0">
                    <path d="M6 7.5a0.8 0.8 0 100 1.6 0.8 0.8 0 000-1.6z" fill="white" stroke="none"/>
                    <path d="M3.8 5.8a3.2 3.2 0 014.4 0" strokeLinecap="round"/>
                    <path d="M1.5 3.5a6 6 0 019 0" strokeLinecap="round"/>
                  </svg>

                  {/* 电池 */}
                  <svg width="20" height="10" viewBox="0 0 20 10" fill="white" style={{ filter: 'brightness(1.3)' }}>
                    <rect x="0.5" y="0.5" width="16" height="9" rx="1.5" stroke="white" strokeWidth="0.8" fill="none"/>

...
const SearchPage = ({ onClose }) => {
  ...
  const defaultData = {
    '资产': [
      { id: 1, code: 'EX-2024-001', name: 'SANY SY365', hours: '12,580 小时', time: '04/13/2026; 10:30', location: '上海市浦东新区', image: '/images/img_excavator.jpg' },
      { id: 2, code: 'EX-2025-002', name: 'SANY 起重机', hours: '8,200 小时', time: '04/12/2026; 14:20', location: '南京市建邺区', image: '/images/img_crane.jpg' },
      { id: 3, code: 'EX-2024-003', name: 'CAT 挖掘机', hours: '3,065 小时', time: '04/11/2026; 09:15', location: '广州市天河区', image: '/images/img_excavator2.jpg' },
      { id: 4, code: 'EX-2024-004', name: 'SANY 泵车', hours: '5,430 小时', time: '04/10/2026; 08:00', location: '深圳市南山区', image: '/images/img_pump.jpg' },
      { id: 5, code: 'EX-2024-005', name: 'XCMG 起重机', hours: '1,890 小时', time: '04/09/2026; 16:45', location: '杭州市西湖区', image: '/images/img_crane2.jpg' },
      { id: 6, code: 'EX-2024-006', name: 'SANY 挖掘机', hours: '6,780 小时', time: '04/08/2026; 11:00', location: '成都市武侯区', image: '/images/img_excavator3.jpg' },
    ],
    '品牌': [
    ...
    '设备类型': [
      { id: 1, name: '挖掘机', code: 'Excavator', deviceCount: 35, image: '/images/img_excavator.jpg' },
      { id: 2, name: '起重机', code: 'Crane', deviceCount: 22, image: '/images/img_crane.jpg' },
      { id: 3, name: '泵车', code: 'Pump Truck', deviceCount: 15, image: '/images/img_pump.jpg' },
      { id: 4, name: '压路机', code: 'Roller', deviceCount: 10, image: '/images/img_roller.jpg' },
      { id: 5, name: '铣刨机', code: 'Milling Machine', deviceCount: 8, image: '/images/img_miller.jpg' },
      { id: 6, name: '搅拌车', code: 'Mixer Truck', deviceCount: 12, image: '/images/img_mixer.jpg' },
    ],
    '配件': [
      { id: 1, name: '液压油滤芯', code: 'HX-2024-001', price: '¥280', stock: '有货', image: '/images/accessory_01.png' },
      { id: 2, name: '空气滤芯', code: 'KQ-2024-002', price: '¥150', stock: '有货', image: '/images/accessory_02.webp' },
      { id: 3, name: '机油滤芯', code: 'JY-2024-003', price: '¥120', stock: '缺货', image: '/images/accessory_03.webp' },
      { id: 4, name: '柴油滤芯', code: 'CY-2024-004', price: '¥95', stock: '有货', image: '/images/accessory_04.webp' },
      { id: 5, name: '履带板', code: 'LD-2024-005', price: '¥1,200', stock: '有货', image: '/images/accessory_05.webp' },
      { id: 6, name: '铲斗齿', code: 'CD-2024-006', price: '¥350', stock: '有货', image: '/images/accessory_06.webp' },
    ],
    '设备分组': [
  ...
  const mockSearchResults = {
    '资产': [
      { id: 1, code: 'C0000138', name: 'KDD PC360 LC-11', hours: '7,841 小时', time: '09/30/2025; 20:00', location: '未报告位置', image: '/images/img_tractor.jpg' },
      { id: 2, code: 'C0000166', name: 'SNA SY215', hours: '未报告小时数', time: '', location: '未报告位置', image: '/images/img_port.jpg' },
      { id: 3, code: '662367', name: 'DEE 624K_DEERE', hours: '8,507 小时', time: '01/07/2026; 19:00', location: '北京市朝阳区', image: '/images/img_dumptruck.jpg' },
      { id: 4, code: 'C0000199', name: 'SANY SY365C', hours: '12,300 小时', time: '03/15/2026; 10:00', location: '上海市浦东新区', image: '/images/img_excavator.jpg' },
      { id: 5, code: 'C0000266', name: 'CAT 320GC', hours: '4,560 小时', time: '02/28/2026; 14:30', location: '广州市天河区', image: '/images/img_excavator2.jpg' },
      { id: 6, code: 'BK02766', name: 'XCMG QY50K', hours: '2,100 小时', time: '04/01/2026; 09:00', location: '南京市建邺区', image: '/images/img_crane.jpg' },
    ],
    '品牌': [
      { id: 1, name: 'SANY', code: '三一重工', deviceCount: 45 },
      { id: 2, name: 'CAT', code: '卡特彼勒', deviceCount: 23 },

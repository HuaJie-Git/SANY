...
export default function NotificationPopover({ onClose, onOpenCategory, onOpenEsc, onOpenMore, onReadAll }) {
  return <div className="pc-notification-layer" role="presentation">
    ...
    <section className="pc-notification-popover" role="dialog" aria-label="消息通知">
      ...
      <div className="pc-notification-groups">
        ...
        <button type="button" className="pc-notification-group is-esc" onClick={onOpenEsc}><i className="is-esc"><EscIcon/></i><span><strong>ESC 事件</strong><small>纯电搅拌车 · 待确认</small></span><time>16:20</time></button>
      </div>
